-- Mesa Foto: área "Clones" (pessoa REAL do cliente, com autorização) e modo 'clone' no acervo (25/09/2026).
-- Fonte: docs/mesa-foto/migrations/04_clones.sql e docs/mesa-foto/CLONES.md. Personas existentes ficam
-- 'sintetica'; clone é pessoa real adulta (18+), autorizada, sempre de um cliente. Escrita só pela função.
