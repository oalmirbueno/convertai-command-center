-- Dossiê bidirecional: o que acontece nas mesas passa sozinho para o painel (MCP 2.3, 25/09/2026).
-- Fonte: docs/cerebro/02_dossie_eventos_das_mesas.sql. Gatilho SÓ ENFILEIRA em dossie_fila; quem
-- reescreve o dossiê é o cron dossie-fila-1min. Movimentos das mesas são todos [interno].

-- 0) Mesa Foto: quando a foto foi aprovada
DO $$
BEGIN
