-- Separate API-gateway credentials from MCP and other api_keys consumers.
-- Existing non-MCP rows intentionally keep a NULL audience and therefore fail
-- closed until their plaintext credential is rotated through the API Docs UI.
