...
function CarouselSlider({ files }: { files: any[] }) {
  ...
  return (
    <div className="relative">
      ...
      <button
        type="button"
        className="absolute z-10 left-2 top-1/2 -translate-y-1/2 bg-background/80 rounded-full p-1.5 opacity-0 group-hover:opacity-100 transition-opacity"
        onClick={(e) => {
          e.stopPropagation();
      ...
      <button
        type="button"
        className="absolute z-10 right-2 top-1/2 -translate-y-1/2 bg-background/80 rounded-full p-1.5 opacity-0 group-hover:opacity-100 transition-opacity"
        onClick={(e) => {
          e.stopPropagation();
