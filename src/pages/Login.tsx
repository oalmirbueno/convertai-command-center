...
export default function Login() {
  ...
  return (
    <div className="dark relative min-h-screen flex flex-col lg:flex-row overflow-hidden bg-background">
        ...
        <div className="relative z-10 flex flex-col justify-between h-full ml-auto pr-14 pl-6 py-10" style={{ maxWidth: "340px" }}>
          ...
          <div className="flex-1 flex flex-col justify-center">
            <div style={{ animation: "fadeInUp 0.5s ease-out 0.2s both" }}>
              <div className="mb-6">
                <img src={aceleriqLogo} alt="Aceleriq" className="h-72 w-auto" />
              </div>
            </div>
      ...
      {/* ═══ RIGHT PANEL ═══ */}
      {/* No celular este painel é a tela inteira, e o pai já garante a altura:
          repetir a altura aqui somava duas telas e deixava uma faixa vazia
          embaixo. Ele agora só ocupa o espaço que sobra. */}
      <div className="flex-1 flex items-center justify-center px-5 sm:px-6 py-8 sm:py-12 lg:w-[45%]" style={{ background: "#121212" }}>
        <div className="w-full max-w-[420px]">
          {/* Mobile logo */}
          <div className="lg:hidden text-center mb-6" style={{ animation: "fadeInUp 0.4s ease-out" }}>
            <img src={aceleriqLogo} alt="Aceleriq" className="h-72 w-auto mx-auto" />
          </div>
          ...
          <div className={cn("login-card", shake && "animate-shake")}>
            ...
            {/* Google */}
            <button type="button" disabled={submitting} onClick={handleGoogleLogin} className="w-full flex items-center justify-center gap-2.5 py-3.5 rounded-xl border border-[#2A2A2A] text-sm text-muted-foreground hover:border-primary hover:text-foreground transition-all cursor-pointer bg-transparent disabled:opacity-50">
