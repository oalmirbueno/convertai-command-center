 ...
 * no próprio painel, sem janela, agrupado por categoria e pasta, com busca.
 * A miniatura usa a URL assinada do bucket de cada imagem.
 */
  ...
  return useQuery({
    ...
    queryFn: async (): Promise<ImagemDoAcervo[]> => {
      const { data, error } = await (supabase as any)
        ...
        .select("id, storage_bucket, storage_path, nome, pasta, categoria, tags, descricao")
  ...
  return (
    <div className="space-y-3 rounded-xl border border-border bg-background p-3">
      ...
      <div className="max-h-[420px] space-y-4 overflow-y-auto pr-1">
        ...
        {filtradas.length > LIMITE_NA_TELA && (
