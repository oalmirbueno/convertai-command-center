...
Com o administrador autenticado, foram conferidos o dashboard, a lista de projetos e o filtro Planejamento/Todos, inclusive o layout desktop. Em Configurações, Segurança abriu `/perfil` e Notificações abriu o painel, fechado sem marcar leitura. A Esteira em `/ciclo` carregou as frentes Social/Tráfego; Social foi restaurada ao concluir. Nenhum formulário foi salvo, senha alterada ou trabalho enviado.
